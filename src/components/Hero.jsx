...
// Recibimos el estado global y la función modificadora desde el archivo index.js
export default function Hero({ walletConectada, setWalletConectada }) {
  
  const connectWallet = () => {
    // Cambiamos el estado global al valor contrario (true / false)
    setWalletConectada(!walletConectada);
  };

  // Usamos una dirección simulada si está conectada
